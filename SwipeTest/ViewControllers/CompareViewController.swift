...
//    
    ...
    func addSwipeRecognizer() {
        let swipeLeft = UISwipeGestureRecognizer(target: self, action: #selector(CompareViewController.swipeleft))
        swipeLeft.direction = UISwipeGestureRecognizerDirection.Left
        
        let swipeRight = UISwipeGestureRecognizer(target: self, action: #selector(CompareViewController.swiperight))
        swipeRight.direction = UISwipeGestureRecognizerDirection.Right
        
        let swipeLeft2 = UISwipeGestureRecognizer(target: self, action: #selector(CompareViewController.swipeleft2))
        swipeLeft2.direction = UISwipeGestureRecognizerDirection.Left
        
        let swipeRight2 = UISwipeGestureRecognizer(target: self, action: #selector(CompareViewController.swiperight2))
